...
tools_list = [{
    ...
    "function": {
        ...
        "description": "Retrieve information of the specific lead like when's the next meeting with them, their email and etc",
        "parameters": {
            "type": "object",
            "properties": {
                "lead_name": {
...
def create_assistants():
    ...
    user_message = "What do we need to prepare for in our next meeting with your manager?"
    ...
    print(f"Message added to the Thread as: {message}")
