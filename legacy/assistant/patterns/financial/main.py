...
assistant = client.beta.assistants.create(
    ...
    instructions = "You are a stock research assistant. Provide educational analysis only, not financial advice.",
    tools=tools_list,
...
message = client.beta.threads.messages.create(
    thread_id=thread.id,
    role="user",
    content="Can you summarize the stock price context and report highlights for educational research?",
    file_ids=[file.id]
)
